...
# Scénario: Ajout d'une notation avec succès
# Date de création: 06/08/2020


#@ACCRETIO2
#@ACCRETIO2-TALENT
#@ACCRETIO2-CONFIGURATIONTALENT
#@ACCRETIO2-CONFIGURATIONTALENT-0023

Feature: Configuration-Talent

  Scenario: Ajout d'une notation avec succès
    ...
    #Etape 003: Ajout de la notation
        ...
        And   l utilisateur saisit "Notation test Auto 1" dans le champs "Libelle_Notation_ajout"
        And   l utilisateur saisit "Description test Auto 1" dans le champs "Descript_Notation_ajout"
       ...
       Then   vérifier que le message "Opération effectuée avec succès" s affiche
        And   verifier que la derniere notation est "Notation test Auto 1"
        And   verifier que la derniere description est "Description test Auto 1"