...
# Scénario: Ajout d'une Notation sans Descrition
...
#@ACCRETIO2-CONFIGURATIONTALENT-0025

Feature: Configuration-Talent

  Scenario: Ajout d'une Notation sans Description
    ...
    #Etape 003: Ajout de la notation
        ...
        And   l utilisateur saisit "Notation test Auto 3" dans le champs "Libelle_Notation_ajout"
        And   l utilisateur saisit " " dans le champs "Descript_Notation_ajout"
        And   l utilisateur saisit "Intitulé test Auto 3" dans le champs "Intitule1_Notation_ajout"
       ...
       Then   vérifier que le champs "Descript_Notation_ajout" est encadre en rouge