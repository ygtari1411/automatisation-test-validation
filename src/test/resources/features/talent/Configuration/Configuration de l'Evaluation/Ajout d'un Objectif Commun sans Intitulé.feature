...
# Scénario: Ajout d'un Objectif Commun sans Intitulé
...
@ACCRETIO2-CONFIGURATIONTALENT-0018

Feature: Configuration-Talent

  Scenario: Ajout d'un Objectif Commun sans Intitulé
    ...
    #Etape 003: Ajout de l'Objectif commun
        ...
        And   l utilisateur saisit " " dans le champs "Libelle_Ajout_Obj_commun"
        And   l utilisateur saisit "Obj test 2" dans le champs "Description_Ajout_Obj_commun"
        ...
        Then   vérifier que le message "Le champ intitulé est obligatoire" s affiche
       #Then   verifier que le champs "libelle_Ajout_Obj_comm" est encadre en rouge