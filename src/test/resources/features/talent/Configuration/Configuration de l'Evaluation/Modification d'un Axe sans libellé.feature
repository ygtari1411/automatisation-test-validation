...
Feature: Configuration-Talent
  ...
  Scenario: Modification d'un Axe sans libellé
    ...
    #Etape 003: Ajout de l'Axe
        ...
        And   l utilisateur saisit "Modification Axe 1" dans le champs "Libelle_Ajout_Axe"
       ...
       Then   vérifier que le message "succès" s affiche
        And    verifier que le dernier libelle axe "Modification Axe 1"

    #Etape 004: Modification de l'axe

       When   l utilisateur clique sur Modifier_option_conf_Axe du dernier axe ajouter
        And l utilisateur modifie "    " dans le champs "Libelle_Ajout_Axe"
        And wait 10000
