...
# Scénario: Ajout d'une Evaluation avec succès
...
#@ACCRETIO2-CONFIGURATIONTALENT-0030
...
Feature: Configuration-Talent
  ...
  Scenario: Ajout d'une Evaluation avec succès
    ...
    #Etape 003: Ajout de l'Evaluation
        ...
        And   l utilisateur saisit "Libelle 1" dans le champs "Libellé_Ajout_Eval"
       ...
       Then   vérifier que le message "L'opération a été effectuée avec succès" s affiche
        And   verifier que le dernier libelle "Libelle 1"