...
# Scénario: Ajout d'une notation sans libellé
# Date de création: 07/08/2020


#@ACCRETIO2
#@ACCRETIO2-TALENT
#@ACCRETIO2-CONFIGURATIONTALENT
#@ACCRETIO2-CONFIGURATIONTALENT-0024

Feature: Configuration-Talent

  Scenario: Ajout d'une notation sans libellé
    ...
    #Etape 003: Ajout de la notation
        ...
        And   l utilisateur saisit " " dans le champs "Libelle_Notation_ajout"
        And   l utilisateur saisit "Description test Auto 2" dans le champs "Descript_Notation_ajout"
       ...
       Then   vérifier que le champs "Libelle_Notation_ajout" est encadre en rouge
