...
# Scénario: Ajout d'un Objectif Commun sans Valeur Cible 1
...
#@ACCRETIO2-CONFIGURATIONTALENT-0021

Feature: Configuration-Talent

  Scenario: Ajout d'un Objectif Commun sans Valeur Cible 1
    ...
    #Etape 003: Ajout de l'Objectif commun
        ...
        And   l utilisateur saisit "Obj test 5" dans le champs "Libellé_Ajout_Obj_commun"
        And   l utilisateur saisit "Obj test 5" dans le champs "Description_Ajout_Obj_commun"
        And   l utilisateur saisit "indicateur 5" dans le champs "Libellé1_Ajout_Obj_commun"
       ...
       Then   vérifier que le champs "Valeur_cible1_Ajout_Obj_commun" est encadre en rouge