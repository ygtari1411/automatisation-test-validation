...
# Scénario: Ajout d'une Notation sans Intitulé 1
...
#@ACCRETIO2-CONFIGURATIONTALENT-0026

Feature: Configuration-Talent

  Scenario: Ajout d'une Notation sans Intitulé 1
    ...
    #Etape 003: Ajout de la notation
        ...
        And   l utilisateur saisit "Notation test Auto 4" dans le champs "Libelle_Notation_ajout"
        And   l utilisateur saisit "Description test Auto 4" dans le champs "Descript_Notation_ajout"
        And   l utilisateur saisit " " dans le champs "Intitule1_Notation_ajout"
       ...
       Then   vérifier que le champs "Intitule1_Notation_ajout" est encadre en rouge
