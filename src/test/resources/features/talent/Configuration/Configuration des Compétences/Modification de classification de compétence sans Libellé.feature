...
Feature: Configuration-Talent
  ...
  Scenario: Ajout classification de compétences
    ...
    #Etape 003: Ajout de la classification
        ...
        And   l utilisateur saisit "Ajout Classification Test auto 8" dans le champs "Libelle_Classif_ajout"
       ...
       Then   vérifier que le message "Opération effectuée avec succès" s affiche
        And   verifier que le dernier libelle "Ajout Classification Test auto 8"
        And   verifier que la derniere classification parent "Communication"
        And   verifier que la derniere echelle "Chiffre"

    #Etape 004: Modification de la classification

        And   l utilisateur clique sur "Classification_conf"
        And   l utilisateur clique sur "Ajouter_classification"
        And   l utilisateur modifie le champs "Libelle_Classif_ajout" a " "
        And   l utilisateur clique sur "Valider_ajout_classification"
        And   l utilisateur clique sur "Sauvegarder_classification"
       Then   vérifier que le message "Le champs valeur est obligatoire" s affiche