   ...
   Scenario: Demande de recrutement par manager avec validation
    ...
    Given   le navigateur est ouvert et la page d'acceuil est affichée
     ...
     Then   verifier que le premier libelle_valid_rec_sup "Test automatique"
      ...
      And   verifier que la premiere ligne de publiee_valid_rec_sup n est pas cochee
        #Verification des champs dans la liste voir historique : bouton fleche dans la colonne Actions#
     ...
     When   le superieur clique sur le bouton fermer_voir_hist_sup
        #Verification des champs dans le modal visualiser le resultat : bouton loupe dans la colonne Actions#
     ...
     Then   le nom de l utilisateur est affiche en haut a gauche
    ...
    #Etape 022: Validation de la demande de recrutement par N+2
     ...
     When   le role_RH_rec saisi "Validation Role RH_Recruitment" dans le champs commentaire
      And   le role_RH_rec choisi l option valider dans la liste actions
     ...
     When   l utilisateur saisi le commentaire_valid_HR_rec "Validation Role RH_Admin"
      And   l utilisateur choisi l action_valid_HR_rec valider
