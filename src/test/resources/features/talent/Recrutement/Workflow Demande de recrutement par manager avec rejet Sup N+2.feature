   ...
   Scenario: Demande de recrutement par manager avec rejet Sup N+2
    ...
    Given   le navigateur est ouvert et la page d'acceuil est affichée
     ...
     When   le manager clique pour ajouter une demande_rec
      And   wait 2000
      And   le manager saisi l intitule_demande_rec "Test automatique 2"
    ...
    #Etape 022: Rejet de la demande de recrutement par N+2
     When   le superieur saisi le commentaire_valid_rec_sup "Rejet N+2"
      And   le superieur selectionne l action rejeter_valid_rec_sup
      And   le superieur clique sur envoyer_valid_rec_sup
      And   le superieur clique sur valider_pop_up_valid_rec_sup
      And   wait 2000
     Then   verifier que le permier libelle_valid_rec_sup n est pas "Test automatique 2"
