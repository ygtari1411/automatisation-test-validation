...
Feature: Gestion du personnel
  ...
  Scenario: Saisie SST_Personnel Guide-fille/Serre-file
    ...
    # Etape 3 : Saisie SST_Personnel Guide-fille/Serre-file
    ...
    And l utilisateur selectionne "Diplôme d'études supérieures spécialisées" dans la liste deroulante "Diplome_Personnel_GuideFile_SerreFile"
    And l utilisateur selectionne "Guide-file" dans la liste deroulante "Type_Personnel_GuideFile_SerreFile"
