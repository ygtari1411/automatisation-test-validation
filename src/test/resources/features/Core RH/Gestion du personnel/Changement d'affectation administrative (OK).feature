...
# Scénario: Changement d'affectation administrative
...
@ACCRETIO2-GESTIONDUPERSONNEL-004

Feature: Gestion du personnel

  Scenario: Changement d'affectation administrative (OK)
    ...
    And l utilisateur saisit "SOC00A" dans le champs "Matricule_collaborateur"
    And l utilisateur selectionne "Monsieur" dans la liste deroulante "Qualité_collaborateur"
    And l utilisateur saisit "Affectation_OK" dans le champs "Nom_collaborateur"
  ...
  # Etape 4 : Changement d'affectation
    ...
    And l utilisateur clique sur "Bouton_Enregister_Collaborateur"
    And vérifier que le message "Opération effectuée avec succès" s affiche
