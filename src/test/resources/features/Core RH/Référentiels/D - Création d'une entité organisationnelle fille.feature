...
Feature: Référentiels : Création Entité organisationnelle fille
  ...
  Scenario: Création Entité organisationnelle fille
    ...
    And l utilisateur selectionne "Faten Mzali" dans la liste deroulante "Responsable_EO"
    ...
    # Etape 6 : Ajout d'une entité mère
    When l utilisateur clique sur "Ajouter_Entité_mère"
    And l utilisateur saisit "01/01/2019" dans le champs "Date_de_début_Entité_mère"
