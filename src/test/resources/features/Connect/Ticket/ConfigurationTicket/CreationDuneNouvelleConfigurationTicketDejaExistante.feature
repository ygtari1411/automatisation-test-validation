...
# Scénario: Création d’une nouvelle configuration ticket déjà existante
...
#@ACCRETIO2-CONNECT
#@ACCRETIO2-TICKET
#@ACCRETIO2-TICKET-0003



Feature: CONFIGURATION TICKET

  Scenario: Création d’une nouvelle configuration ticket déjà existante
    ...
    #Etape4 : Vérifier l’ajout de la configuration n’a pas été effectué

     #Then verifier qu’un message d’erreur s’affiche
     Then verifier que la configuration ticket n’à pas  été ajoutée
