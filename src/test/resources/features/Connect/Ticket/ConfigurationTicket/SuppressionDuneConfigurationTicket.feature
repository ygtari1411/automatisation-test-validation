...
# Scénario:Suppression d’une configuration ticket
...
#@ACCRETIO2-CONNECT
#@ACCRETIO2-TICKET
#@ACCRETIO2-TICKET-0005



Feature: CONFIGURATION TICKET

  Scenario: Suppression d’une configuration ticket
   ...
   #Etape3 : Remplir les champs de la configuration
     ...
     And wait 3000
     And l utilisateur selectionne "Infrastructure" dans la liste deroulante "Liste_Deroulante_Categorie_Ticket"
     And l utilisateur selectionne "Accès et droits" dans la liste deroulante "Type_Categorie_Ticket"
   ...
   #Etape5 : Vérifier la suppression de la configuration

    Then verifier que la configuration a été supprimée
