...
# Scénario: Vérification de la durée au workflow collaborateur manager rh: Jour ouvrable
...
#@ACCRETIO2-EASYRUN
#@ACCRETIO2-ABSENCES
#@ACCRETIO2-ABSENCES-0011

Feature: Absences

  Scenario: Vérification de la durée au workflow collaborateur manager rh: Jour ouvrable
    ...
    And l utilisateur selectionne "Congés Payés W2 Durée en jour ouvrable" dans la liste deroulante "Motif_d_absence_Ajout_Demande_Absence_Collaborateur"
