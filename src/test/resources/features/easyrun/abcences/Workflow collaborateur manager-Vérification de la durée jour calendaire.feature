...
# Scénario: Vérification de la durée au workflow collaborateur manager: Jour calendaire
...
Feature: Absences
  ...
  Scenario: Vérification de la durée au workflow collaborateur manager: Jour calendaire
    ...
    And l utilisateur selectionne "Congés Payés W1 Durée en jour calendaire" dans la liste deroulante "Motif_d_absence_Ajout_Demande_Absence_Collaborateur"
