...
# Scénario: Vérification de la durée au workflow collaborateur manager rh: Jour ouvré
...
@ACCRETIO2-EASYRUN
@ACCRETIO2-ABSENCES
@ACCRETIO2-ABSENCES-0012

Feature: Absences

  Scenario: Vérification de la durée au workflow collaborateur manager rh: Jour ouvré
    ...
    And l utilisateur selectionne "Congés Payés W2 Durée en jour ouvré" dans la liste deroulante "Motif_d_absence_Ajout_Demande_Absence_Collaborateur"
   # And l utilisateur selectionne "Mehrez Somrani" dans la liste deroulante "Backup_Ajout_Demande_Absence_Collaborateur"
    ...
    And l utilisateur vérifie que "Champ_Durée_Absence" a la valeur "1 jour(s)"
