...
Feature: Absences: Rejet de l'annulation au workflow collaborateur manager
  ...
  Scenario: Rejet de l'annulation au workflow collaborateur manager
    ...
    And l'utilisateur clique sur Absences
    And l'utilisateur clique sur l'icône Accepter la demande d'absence
    And la fenêtre de confirmation de la validation de la demande d'absence s'affiche à l'écran
    And l'utilisateur clique sur Valider la demande d'absence au niveau de la fenêtre de confirmation de validation de la demande d'absence
    And le message Opération effectuée avec succés s'affiche à l'ecran
   ...
   #Etape 5 : Profil collaborateur-Annulation de la demande d'absence
    ...
    And l'utilisateur clique sur l'icône Rejeter l'annulation de demande d'absence
    And la fenêtre de confirmation du rejet de l'annulation de la demande d'absence s'affiche à l'écran
    And l'utilisateur ajoute un commentaire "Rejet" et clique sur Valider le rejet d'annulation de la demande d'absence au niveau de la fenêtre de confirmation d'annulation de la demande d'absence
    And le message Opération effectuée avec succés s'affiche à l'ecran
    And Vérifier que la demande d'absence est déplacée au niveau de la rubrique Historique et que son statut devient Validée
