...
public class TimelineLocators {
    ...
    public static final String Bouton_Menu_Modif_Supp_Statut = ".poste-single:nth-child(2) > #post-holder .icon-arrow-down" ;
    public static final String Bouton_Modif_Statut = "Modifier";
