...
public class ModificationDunAxeSansLibelle {

    private static final WebDriver driver = GenerateurDriver.driver;
    private ActionsCommunes action = new ActionsCommunes();

    @When("l utilisateur clique sur Modifier_option_conf_Axe du dernier axe ajouter")
    public void lUtilisateurCliqueSurModifier_option_conf_AxeDuDernierAxeAjouter() throws InterruptedException {
        ...
        afterXpath=") > td.text-right.dropup > div > ul > li:nth-child(1) > a";
